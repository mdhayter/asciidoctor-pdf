  ...
  module Cli
    ...
    class Invoker
      ...
      def invoke!
        ...
        if diffile
          err.puts "found diff file!!!"
          diff_doc = ::Asciidoctor.load_file diffile, opts
          main_doc = ::Asciidoctor.load_file infiles[0], opts
          #pp main_doc

          difftree(main_doc, diff_doc)
          o = main_doc.convert opts
          main_doc.write o, tofile
        elsif stdin
